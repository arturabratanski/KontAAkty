...
/**
 * Most of this code is copied! It allows data to be read and written.
 * For database connection code written by me please visit other projects:
 * https://github.com/arturabratanski/Employee-CRUD
 * https://github.com/arturabratanski/Customer-Relationship-Manager
 * I have created code responsible for singleton creation as well as observable list control.
 */
...
public class ContactData {
    ...
    private static ContactData instance = new ContactData(); // instantiating new object to access singleton ContactData
    ...
    // creating a "getter" for instance, it return our singleton
    public static ContactData getInstance() {
        return instance;
    }

    public ContactData() {
        contacts = FXCollections.observableArrayList(); // initialize the contacts list, its fx version of observable list
    }

    public void addContact(Contact contact) { // method to add contact to list
        contacts.add(contact);
    }

    public void deleteContact(Contact contact) { // method to remove contact from list
        contacts.remove(contact);
    }

    public ObservableList<Contact> getContacts() { // method to return observable list from singleton
        return contacts;
    }
    ...
    private void saveContact(XMLEventWriter eventWriter, XMLEventFactory eventFactory, Contact contact)
        ...
        createNode(eventWriter, FIRST_NAME, contact.getName());
        createNode(eventWriter, LAST_NAME, contact.getSurname());
